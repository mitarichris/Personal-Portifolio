...
const portfolioData = {
  ...
  projects: [
    ...
    { title: 'Iga Hub', description: 'School management portal for managing student records, classes, attendance, grades, and announcements.', tech: ['TypeScript', 'React', 'Node.js', 'Express', 'MongoDB'] },
