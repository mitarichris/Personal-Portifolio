...
const portfolioData = {
  ...
  projects: [
    ...
    { title: 'HR Management System', description: 'HR platform for managing employee records, attendance, leave requests, payroll, and performance reviews.', tech: ['React', 'Express', 'MySQL', 'Tailwind CSS'] },
    { title: 'Fleet Management Solution', description: 'Fleet tracking and management with vehicle scheduling, maintenance logs, fuel tracking, driver assignment, and real-time analytics.', tech: ['React', 'Node.js', 'MongoDB', 'Tailwind CSS'] },
  ],
  services: [
